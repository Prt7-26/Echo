...
- ⬜ **Step 13+**: Open work — M1 adaptive trigger (3/4 conditions; semantic recurrence blocked by lack of embedding infrastructure), Tauri shell + clipboard IPC, dashboard widget for preference examples + scope override.
