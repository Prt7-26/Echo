...
- ⬜ **Step 11+**: Open work — M5 preference store + few-shot RAG, M1 adaptive trigger (3/4 conditions; semantic recurrence blocked by lack of embedding infrastructure), Tauri shell + clipboard IPC.
