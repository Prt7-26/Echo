...
- ⬜ **Step 7+**: Open work — pick from Layer B NL sentiment classifier (auxiliary client), M2 scope-confirmation dialog, M5 preference store + few-shot RAG, M1 adaptive trigger, Tauri shell + clipboard IPC.
