...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "dashboard.theme": {
        ...
        "options": ["default", "echo-light", "midnight", "ember", "mono", "cyberpunk", "rose"],
    },
...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Echo",                "description": "Sonar teal on deep water — Echo's dark mode"},
    {"name": "echo-light",    "label": "Echo Light",          "description": "Bright ivory canvas with teal ink — Echo's daytime mode"},
    {"name": "default-large", "label": "Echo (Large)",        "description": "Echo with bigger fonts and roomier spacing"},
